...
(function($, version)
{
          ...
          var isLessThanIE7 = parseFloat(navigator.appVersion.split('MSIE')[1]) < 7 && document.body.filters, // needed to run the AlphaImageLoader function for IE6
            ...
            show =
              function()
              {
                ...
                if (settings.window.expandable)
                {
                  $(document.body).children('div.jPicker.Container').css({zIndex:9999});
                ...
                switch (settings.window.effects.type)
                {
                  ...
                  case 'slide':
                	  //팝업 창올라오는 부분
                	  //console.log(settings.window.effects.speed);
                	//$(".Container").hide();
            ...
            hide =
              function()
              {
                var removeIFrame = function()
                  {
                    if (settings.window.expandable) container.css({ zIndex: 9999 });
                    if (!settings.window.expandable || $.support.boxModel) return;
              ...
              function()
              {
                ...
                if (win.expandable)
                {
                  ...
                  container.css( // positions must be set and display set to absolute before source code injection or IE will size the container to fit the window
                    {
                      left:
                        win.position.x == 'left' ? (popup.offset().left + 100 - (win.position.y == 'center' ? 25 : 0)) + 'px' :
                      ...
                      position: 'absolute',
                      top: win.position.y == 'top' ? (popup.offset().top + 100) + 'px' :
  ...
  $.fn.jPicker.defaults = /* jPicker defaults - you can change anything in this section (such as the clientPath to your images) without fear of breaking the program */
      ...
      images:
        {
          //clientPath: 'js/ol/jpicker/img/', /* Path to image files */
          clientPath: ctx + '/js/libs/jpicker/img/',
          colorMap:
          {
            width: 256,
            height: 256,
